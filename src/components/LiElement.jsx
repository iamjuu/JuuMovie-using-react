...
<ul className='flex gap-10 m-3 hidden sm:flex z-10'>
  <li className='hover:text-yellow-500 transition-colors duration-300 cursor-pointer'>popular</li>
  <li className='hover:text-yellow-500 transition-colors duration-300 cursor-pointer'>theatre</li>
